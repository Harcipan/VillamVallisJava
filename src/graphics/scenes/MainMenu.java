...
public class MainMenu extends JPanel {
    ...
    public MainMenu(SceneManager manager, GameLoopCallback glCback) {
        ...
        newGameButton.addActionListener(e -> {manager.showScene("GameScene"); glCallback.newGame();});
        //TODO: add logic to disable if there are no saves to continue or serial version isn't matching
        contGameButton.addActionListener(e -> {manager.showScene("GameScene"); glCallback.continueGame();});
